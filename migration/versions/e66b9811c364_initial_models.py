...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('MANGA', 'MANHWA', 'MANHUA', 'OEL_MANGA', name='typeenum'), nullable=False),
    sa.Column('status', sa.Enum('ONGOING', 'COMPLETED', 'DISCONTINUED', 'ANNOUNCED', name='statusenum'), nullable=False),
    sa.Column('release_format', sa.Enum('YONKOMA', 'ANTHOLOGY', 'DOUJINSHI', 'COLORED', 'ONE_SHOT', 'WEB', 'WEBTOON', name='releaseenum'), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
